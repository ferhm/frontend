(self["webpackChunkGCLoud_Granada"] = self["webpackChunkGCLoud_Granada"] || []).push([["common"],{
...
/***/ 1067:
/*!************************************************************************!*\
  !*** ./src/app/pages/achievement-list/services/achievement.service.ts ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let AchievementService = class AchievementService {
    ...
    getChallenges(currentElement, elementsPerPage) {
        ...
        return this.apiService.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.API_URL + src_app_shared_config_constants_api_constants__WEBPACK_IMPORTED_MODULE_0__.RequestEndpoints.GET_CHALLENGES, httpParams).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)((data) => (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            return data;
    ...
    getChallenge(id) {
        ...
        return this.apiService.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.API_URL + src_app_shared_config_constants_api_constants__WEBPACK_IMPORTED_MODULE_0__.RequestEndpoints.GET_CHALLENGE, httpParams).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)((data) => (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            return data;
        })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(error => (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.throwError)(error)));
    }
    processChallenge(id, extras) {
        let httpParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpParams();
        httpParams = httpParams.append('id', id);
        if (extras)
            httpParams = httpParams.append('extras', JSON.stringify(extras));
        return this.apiService.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.API_URL + src_app_shared_config_constants_api_constants__WEBPACK_IMPORTED_MODULE_0__.RequestEndpoints.PROCESS_CHALLENGE, httpParams).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)((data) => (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            return data;
        })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(error => (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.throwError)(error)));
    }
};
...
AchievementService = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
...
/***/ 1637:
/*!****************************************************!*\
  !*** ./src/app/shared/models/achievement.model.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "AchievementState": () => (/* binding */ AchievementState),
/* harmony export */   "ChallengeTypeEnum": () => (/* binding */ ChallengeTypeEnum),
/* harmony export */   "ChallengeType": () => (/* binding */ ChallengeType),
/* harmony export */   "UserChallenge": () => (/* binding */ UserChallenge),
/* harmony export */   "UserChallengeState": () => (/* binding */ UserChallengeState)
/* harmony export */ });
class Achievement {
    constructor() { }
}
...
(function (AchievementState) {
    AchievementState["NONE"] = "NOT_STARTED";
    AchievementState["STARTED"] = "STARTED";
    AchievementState["PENDING"] = "PENDING_ACCEPT";
    AchievementState["ACCEPTED"] = "ACCEPTED";
    AchievementState["FINISHED"] = "FINISHED";
    AchievementState["REJECTED"] = "REJECTED";
})(AchievementState || (AchievementState = {}));
var ChallengeTypeEnum;
(function (ChallengeTypeEnum) {
    ChallengeTypeEnum["COURSE"] = "COURSE";
    ChallengeTypeEnum["EVENT"] = "EVENT";
})(ChallengeTypeEnum || (ChallengeTypeEnum = {}));
class ChallengeType {
}
class UserChallenge {
}
class UserChallengeState {
}
